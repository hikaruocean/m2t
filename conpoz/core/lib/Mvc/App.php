...
class App
{
    ...
    public $actionName;
    public $dispatchTimes = 0;
    public $dispatchTimesLimit = 2;
    ...
    {
        if (++ $this->dispatchTimes > $this->dispatchTimesLimit) {
            throw new \Exception('Dispatch Loop Great Than Limit Times ' . $this->dispatchTimesLimit);
            return false;
        }
